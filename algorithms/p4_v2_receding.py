# -*- coding: utf-8 -*-
"""第四题 v2：滚动时域 + 真实代价计价 + 牛耕式铺清 + 预测误差最小的候选点排序。
...
class P4V2Hunter(P4Hunter):
    """v2：v1 的布站/判据不动，换掉铺清、候选点排序与主循环计价。"""
...
SPEC = AlgorithmSpec(
    ...
    params=dict(P4V2Hunter.DEFAULTS),
    entry="algorithms/p4_v2_receding.py: P4V2Hunter",
)


def build(sim, params: dict | None = None, *, verbose: bool = False):
    return P4V2Hunter(sim, params, verbose=verbose)
